...
public class RepoBusquedas {
	...
	public void crearBusquedas(){
		...
		addBusqueda(new Busqueda(new DateTime().withDate(2016, 1, 21).withHourOfDay(23).withMinuteOfHour(52), " mBrandes ", " direccion: Av. Medrano 951 ", 1, "UTN"));
		...
		addBusqueda(new Busqueda(new DateTime().withDate(2016, 7, 26).withHourOfDay(22).withMinuteOfHour(52), " mHuayta ", " direccion: Av. Caseros 4200 ", 3, "Parada del 101, Parada del 150, Remiseria Juanito"));
		addBusqueda(new Busqueda(new DateTime().withDate(2016, 8, 12).withHourOfDay(5).withMinuteOfHour(5), " jBenitez ", " direccion: Av. Libertador 1557 ", 2, "Parada del 31, Parada del 75"));
		addBusqueda(new Busqueda(new DateTime().withDate(2015, 10, 8).withHourOfDay(18).withMinuteOfHour(18), " nLuis ", " nombre: kkjhty ", 0, ""));
		addBusqueda(new Busqueda(new DateTime().withDate(2016, 1, 20).withHourOfDay(12).withMinuteOfHour(6), " mBrandes ", " nombre: McDonalds", 4, "McDonalds, McDonalds, McDonalds, McDonalds"));
		...
		addBusqueda(new Busqueda(new DateTime().withDate(2016, 5, 25).withHourOfDay(20).withMinuteOfHour(5), " mHuayta ", " direccion: Av. San Martin 3100 ", 2, "CGP_17, Parada del 18"));
	}
